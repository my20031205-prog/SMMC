...
<head>
  ...
  <title>Delta IA Strategy SPA</title>
  <!-- Tailwind CSS -->
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
  ...
  <script type="text/babel">
    ...
    // --- Inline SVG Icons ---
    const Icons = {
      Menu: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16"></path></svg>,
      X: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12"></path></svg>,
      Sun: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>,
      Moon: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>,
      Globe: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>,
      ChevronRight: ({ className, size }) => <svg width={size} height={size} className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7"></path></svg>
    };
    ...
    function App() {
      ...
      // Toggle Dark Mode natively using Tailwind class
      useEffect(() => {
        if (isDarkMode) {
      ...
      return (
        <div className={`min-h-screen flex flex-col font-sans transition-colors duration-300 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>
          ...
          <header className={`sticky top-0 z-40 w-full shadow-md transition-colors duration-300 ${isDarkMode ? 'bg-gray-800 border-b border-gray-700' : 'bg-white border-b border-gray-200'}`}>
            <div className="flex items-center justify-between px-4 h-16 max-w-7xl mx-auto">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  {isMenuOpen ? <Icons.X size={24} className="text-[#005A9C]" /> : <Icons.Menu size={24} className="text-[#005A9C]" />}
                </button>
              ...
              <div className="flex items-center space-x-1 md:space-x-3">
                ...
                >
                  <Icons.Globe size={20} className="text-[#005A9C]" />
              ...
              <nav className="p-4 space-y-2 mt-2">
                {Object.entries(t.sections).map(([key, label]) => (
                  ...
                  >
                    ...
                    {activeTab === key && <Icons.ChevronRight size={16} />}
                  </button>
                ))}
              </nav>
            </aside>
